...
export function Signin() {
  ...
  const handleData = (e) => {
    ...
    axios.post(`https://clothing-ecommerce-website-mu76.vercel.app/user/userlogin`, form)
      .then((res) => {
        console.log("Response:", res.data);
        if (res.data) {
          setValue(res.data); // Update state with the response
          localStorage.setItem("clothwabsitetoken", JSON.stringify(res.data)); // Store in localStorage
          navigate("/");
        }
      })
      .catch((error) => {
      ...
      <div className="w-full lg:w-3/5 mt-20">
        ...
        <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2" onSubmit={handleData}>
          ...
          <Typography variant="paragraph" className="text-center text-blue-gray-500 font-medium mt-4">
            Not registered?
            <Link to="/singup" className="text-gray-900 ml-1">Create account</Link>
          </Typography>
        </form>
